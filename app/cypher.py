class Cypher:
	...
	block_add = (
		...
		'	-[:SUBMITTED]->(b:Blocks), '
		'	(id:Counter { '
		'		uid: (toInteger($trial_uid) + "_block") '
		'	}) '
		'	-[:FOR]->(tb: TrialBlocks) '
		'	-[:IS_IN]->(trial:Trial) '
		' SET '
		...
		'		uid: (toInteger($trial_uid) + "_B" + id.count), '
		'		id: id.count '
		'	}) '
		'	-[:IS_IN]->(tb) '
		' 	ON CREATE SET '
	...
	trees_add = (
		...
		' 	CREATE '
		'		(t: Tree: Item { '
		'			uid: (toInteger($trial_uid) + "_T" + id.count), '
		'			id: id.count, '
		'			custom_id: "", '
		'			variety: "" '
		'		}) '
	...
	trees_add_block = (
		...
		# find the id counter node (trial tree counter)
		' MATCH '
		'	(id:Counter {uid: (toInteger($trial_uid) + "_tree")}), '
	...
	branches_add = (
		...
		'		uid: (toInteger($trial_uid) + "_branch") '
		'	}), '
	...
	samples_add = (
		...
		'	}), '
		'	(id:Counter { '
		'		uid: (toInteger($trial_uid) + "_sample") '
		'	}) '
