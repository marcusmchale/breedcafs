class Cypher:
	...
	shared_upload_code = (
		...
		'		ELSE '
		'			apoc.date.parse(item.harvest_text_date + " " + item_harvest_text_time, "ms", "yyyy-MM-dd HH:mm") '
		'		END '
	...
	merge_field_condition = (
		...
		' MATCH '
		'	(condition: Condition {name_lower: $condition}) '
		' MERGE '
		'	(condition) '
		'	<-[:FOR_CONDITION]-(ic:ItemCondition) '
		'	-[:FOR_ITEM]->(field) '
