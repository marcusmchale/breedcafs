class Cypher:
	...
	shared_upload_code = (
		...
		' WITH '
		'	field, item, feature, time, start, end, replicate, '
		'	person, '
		...
		' WITH '
		'	field, item, feature, item_feature, coalesce(field_feature, item_feature) as field_feature, '
		'	time, start, end, '
		'	location, timestamp, text_time, text_date, text_start_time, text_start_date, text_end_time, text_end_date, '
		...
		' WITH '
		'	field, item, feature, item_feature, field_feature, '
		'	time, start, end, '
		'	location, timestamp, text_time, text_date, text_start_time, text_start_date, text_end_time, text_end_date, '
		'	replicate, value, person, '
		'	data_sub, '
		...
		'	AND trait.name_lower = "assign custom id" '
		'	THEN toString(d.value) '
		'	ELSE item.custom_id '
		'	END '		
		' MATCH '
		'	(user:User)-[:SUBMITTED*..7]->()-[submitted:SUBMITTED]->(r) '
		...
		'	text_date: r.text_start_date, '
		'	text_time: r.text_start_time, '
		'	text_date: r.text_end_date, '
		'	text_time: r.text_end_time '
		' } '
	)
	...
	upload_table_check = (
		...
		'					END '
		'		}) '
		'	WITH item, feature, csvLine[feature_name] as value '
		' 	WITH '
		'		CASE WHEN item IS NULL THEN False ELSE True END as item, '
