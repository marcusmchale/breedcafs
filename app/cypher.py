class Cypher:
	...
	leaves_get = (
		...
		' OPTIONAL MATCH '
		'	(tree) '
		'	-[is_in: IS_IN]->(: BlockTrees)-[:IS_IN]-(block: Block) '
	...
	shared_upload_code = (
		...
		' OPTIONAL MATCH '
		'	(variety_name_update:Variety {name_lower: toLower(value)}) '
		# or by code
		' OPTIONAL MATCH '
		'	(variety_code_update:Variety {el_frances_code_lower: toLower(value)}) '
		' WITH '
		'	item, trait, item_trait, time, value, data_sub, '
		'	plot_item_plot, tree_item_tree, tree_item_plot, '
		'	person, '
