class Cypher:
	...
	existing_block_condition = (
		...
		'	-[:FROM_FIELD]->(: Field {uid: $field_uid}), '
		'	(fic)'
		'	<-[:FOR_CONDITION]-(ic:ItemCondition) '
	...
	existing_field_tree_condition = (
		...
		'	(ic)'
		'	<-[:RECORD_FOR]-(r:Record) '
		'	<-[sub: SUBMITTED]-(: RecordSubmissions)'
		'	<-[: SUBMITTED]-(: Submissions)'
		'	<-[: SUBMITTED]-(u: User)'
		'	WHERE '
		'		r.start < $end '
	...
	merge_field_condition = (
		...
		'	WHERE "field" in condition.levels '
		' MERGE '
		'	(condition) '
		'	<-[:FOR_CONDITION]-(ic:ItemCondition) '
		'	-[:FOR_ITEM]->(field) '
	...
	merge_block_condition = (
		...
		' MATCH '
		'	(condition: Condition {name_lower: $condition}) '
		'	WHERE "block" in condition.levels '
		' MERGE '
		'	(condition) '
		'	<-[:FOR_CONDITION]-(fic:FieldItemCondition) '
		'	-[:FROM_FIELD]->(field) '
	...
	merge_field_tree_condition = (
		...
		'		name_lower: toLower($condition) '
		'	}) '
		'	WHERE "tree" in condition.levels '
		' MATCH '
		'	(tree:Tree) '
		'	-[:IS_IN]->(:FieldTrees) '
		'	-[:IS_IN]->(field: Field {uid: $field_uid}) '
